...
function e(e, t, n, i, r) {
    ...
    this.update = function () {
        if (!this.textures) {
            this.textures = e.data.sections.textures.items;
            this.collection = e.data.sections.collection;
    ...
    this.clearTextureState = function () {
        if (e.data.projects.textures.loaded || e.currstate.to.data.type != r.PagesTypes.WALL)
